...
public class SCAICore {
    ...
    final private static String IMU_QUERY = "http://192.168.0.5/cgi-bin/imuQueryMock.fcgi";
    //final private static String GPS_QUERY = "http://192.168.1.3/cgi-bin/gpsQueryMock.fcgi";
    final private static String GPS_QUERY = "http://192.168.0.5/cgi-bin/gpsQueryMock.fcgi";
